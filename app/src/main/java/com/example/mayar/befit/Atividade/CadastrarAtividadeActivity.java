...
public class CadastrarAtividadeActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botao_cadastrar = findViewById(R.id.id_botao_cadastrar_atividade);
        ...
        marca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case DialogInterface.BUTTON_POSITIVE:
                                Toast.makeText(CadastrarAtividadeActivity.this, "Cadastro cancelado.", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(CadastrarAtividadeActivity.this, MainActivity.class));
                                break;
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(CadastrarAtividadeActivity.this, R.style.AlertDialog);
        ...
        botao_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(CadastrarAtividadeActivity.this,  R.style.AlertDialog, new DatePickerDialog.OnDateSetListener() {
        ...
        botao_horario_inicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(CadastrarAtividadeActivity.this,  R.style.AlertDialog, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        horario_inicio.setText(hourOfDay+":"+minute);
                    }
                }, hora, minuto, DateFormat.is24HourFormat(CadastrarAtividadeActivity.this));
        ...
        botao_horario_fim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }, hora+1, minuto, DateFormat.is24HourFormat(CadastrarAtividadeActivity.this));
        ...
        if(isServicesAvailable()){
            ...
            botao_mapa.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(CadastrarAtividadeActivity.this, MapActivity.class);
                ...
                modalidadeReference.orderByChild("nome_mod").equalTo(selectedItem)
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for(DataSnapshot dados:dataSnapshot.getChildren()){
                            ...
                            atividade.setCod_atv(UUID.randomUUID().toString());
                            ...
                            //criando nó de participante;
                            firebaseUser = firebaseAuth.getCurrentUser();
                            participante.setCod_atv_parti(atividade.getCod_atv());
                            participante.setStatus_parti(0); //0 - aprovado; 1 - aguardando aprovação;
                            participante.setCod_parti(UUID.randomUUID().toString());
                            participante.setCod_usu_parti(firebaseUser.getUid());
                            participante.setId_parti(atividade.getQparticipante_atv());
                            participante.setTipo_parti(1); //0 - padrão; 1 - gerenciador;
                            ...
                            Toast.makeText(CadastrarAtividadeActivity.this, "Cadastrada!", Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(CadastrarAtividadeActivity.this, AtividadeMainActivity.class);
        ...
        DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case DialogInterface.BUTTON_POSITIVE:
                        Toast.makeText(CadastrarAtividadeActivity.this, "Cadastro cancelado.", Toast.LENGTH_SHORT).show();
                        CadastrarAtividadeActivity.super.onBackPressed();
                        break;
    ...
    public boolean isServicesAvailable(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(CadastrarAtividadeActivity.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(CadastrarAtividadeActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
            Toast.makeText(CadastrarAtividadeActivity.this, "Não é possível realizar requisições no mapa.", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
}
