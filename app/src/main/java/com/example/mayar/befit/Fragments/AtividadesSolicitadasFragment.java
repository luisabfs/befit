 ...
 */
public class AtividadesSolicitadasFragment extends Fragment {
    ...
    private static final String TAG = "SolicitadasFragment";
    public AtividadesSolicitadasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_atividades_solicitadas, container, false);

        populateRecyclerView();
        recyclerView = rootView.findViewById(R.id.rv_atividades_solicitadas);
